...
def draw_square_spiral(screen):
    ...
    while x >= 0 and x <= screen_size and y >= 0 and y <= screen_size:
        ...
        if 0 == 0:  
            pygame.draw.line(screen, WHITE, (center_x-x/6, center_y-y/2),(center_x+x/6,center_y-y/2),1)
            pygame.draw.line(screen, WHITE, (center_x+x/6, center_y+y/2),(center_x-x/6,center_y+y/2),1)
            pygame.draw.line(screen, WHITE, (center_x-x/2, center_y-y/6),(center_x-x/2,center_y+y/6),1)
            pygame.draw.line(screen, WHITE, (center_x+x/2, center_y-y/6),(center_x+x/2,center_y+y/6),1)
            pygame.draw.line(screen, WHITE, (center_x+x/2, center_y-y/6),(center_x+x/6,center_y-y/2),1)
            pygame.draw.line(screen, WHITE, (center_x+x/2, center_y+y/6),(center_x+x/6,center_y+y/2),1)
            pygame.draw.line(screen, WHITE, (center_x-x/2, center_y+y/6),(center_x-x/6,center_y+y/2),1)
            pygame.draw.line(screen, WHITE, (center_x-x/2, center_y-y/6),(center_x-x/6,center_y-y/2),1)
            x=x+step
